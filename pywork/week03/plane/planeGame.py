...
class Biu():
    def __init__(self,x,y,wind):
        ...
        self.y=y
        self.wind=wind
        self.pic=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\bullet.png')
    def draw(self):
...
class EnemyBiu():
    def __init__(self,x,y,wind):
        ...
        self.y=y
        self.wind=wind
        self.pic=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\bullet1.png')
    def draw(self):
        self.wind.blit(self.pic,(self.x,self.y))
        self.move()
    def move(self):
...
background=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\background.png')
icon=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\icon72x72.png')
heroPlan1=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero1.png')
heroPlan2=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero2.png')
heroBombImageList=[r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero_blowup_n1.png',r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero_blowup_n2.png',r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero_blowup_n3.png',r'E:\python使用软件\IT研究院-Python\New_Stydy\img\hero_blowup_n4.png']
enemyPlan=pygame.image.load(r'E:\python使用软件\IT研究院-Python\New_Stydy\img\enemy1.png')
